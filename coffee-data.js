...

{
    ...
    preparation: "Za pripravo se uporablja espresso aparat. Napitek je pripravljen z ekstrakcijo tekoče-trdno fino mlete kave z vročo vodo (do 96 °C) pri relativnem tlaku cca. 9 bar. Čas ekstrakcije za 30 mL napitka je nekoliko krajši od 30 sekund.",
    caffeine: 1.5,
    ...
    
{
    ...
    preparation: "Za pripravo se uporablja espresso aparat. Napitek je pripravljen z ekstrakcijo tekoče-trdno fino mlete kave z vročo vodo (do 96 °C) pri relativnem tlaku cca. 9 bar. Ekstrakcija za 20 mL napitka traja okoli 20 sekund.",
    caffeine: 1,
...

{
    ...
    preparation: "Za pripravo se uporablja espresso aparat. Napitek je pripravljen z ekstrakcijo tekoče-trdno fino mlete kave z vročo vodo (do 96 °C) pri relativnem tlaku cca. 9 bar. Ekstrakcija za 60 mL napitka traja okoli eno minuto.",
    caffeine: 1.5,
...

{
    ...
    preparation: "Za pripravo se uporablja espresso aparat. Napitek je pripravljen z ekstrakcijo tekoče-trdno fino mlete kave z vročo vodo (do 96 °C) pri relativnem tlaku cca. 9 bar. Ekstrakcija za 60 mL napitka traja okoli 30 sekund.",
    caffeine: 2.5,
...

{
    ...
    preparation: "Pri pripravi americana se najprej s pomočjo espresso aparata pripravi dve porciji espressa – doppio – (fino mleta kava in do 96 °C voda, 30 sekundna ekstrakcija tekoče-trdno pri cca. 9 barg)kar je 60 mL, nato pa se dolije vroča voda (180 mL), kar je glavna razlika v primerjavi z napitkom long black.",
...

{
    ...
    preparation: "Za pripravo se uporablja espresso aparat. Napitek je pripravljen z ekstrakcijo tekoče-trdno bolj grobo mlete kave z vročo vodo (do 96 °C) pri relativnem tlaku cca. 9 bar. Čas ekstrakcije za 180 mL napitka je nekoliko daljši od 30 sekund.",
    caffeine: 2,
...

{
    ...
    preparation: "Za pripravo se uporablja espresso aparat. Napitek je pripravljen z ekstrakcijo tekoče-trdno fino mlete kave z vročo vodo (do 96 °C) pri relativnem tlaku cca. 9 bar. Čas ekstrakcije za 30 mL napitka je nekoliko krajši od 30 sekund. Na koncu se na rob skodelice napitka doda še rezina limone ali zvitek njenega olupka.",
    caffeine: 1.5,
    ...
    
{
    ...
    preparation: "Za pripravo se uporablja espresso aparat. Napitek je pripravljen z ekstrakcijo tekoče-trdno fino mlete kave z vročo vodo (do 96 °C) pri relativnem tlaku cca. 9 bar. Čas ekstrakcije za 30 mL napitka je nekoliko krajši od 30 sekund. Najprej se v kozarec da dve rezini limete in se ju prelije z dvojnim espressom (doppiom). Po želji lahko dodamo tudi kocke ledu.",
    caffeine: 2.5,
...

{
    ...
    preparation: "Za pripravo osnove napitka, ene (espresso, 30 mL) ali dveh porcij espressa (doppio, 60 mL), se uporablja espresso aparat (fino mleta kava in do 96 °C voda, 30 sekundna ekstrakcija tekoče-trdno pri cca. 9 barg). Prav tako se z njim pogosto pripravi cca. 240 mL parjenega mleka (toplo mleko, ki ga segrejemo in kremasto prezračimo z vročo vodno paro), s katerim prekrijemo osnovo. Na koncu pa se celotna tekočina prekrije še z mlečno peno, ki se pripravi s penilnikom mleka.",
    caffeine: {min: 1.5, max: 2.5},
...

{
    ...
    preparation: "Za pripravo osnove napitka, ena (espresso, 30 mL) ali dve porciji espressa (doppio, 60 mL), se uporablja espresso aparat (fino mleta kava in do 96 °C voda, 30 sekundna ekstrakcija tekoče-trdno pri cca. 9 barg). Prav tako se z njim pogosto pripravi parjeno mleko (toplo mleko, ki ga segrejemo in kremasto prezračimo z vročo vodno paro), 30 mL ali 60 mL, s katerim prekrijemo osnovo.",
    caffeine: {min: 1.5, max: 2.5},
...

{
    ...
    preparation: "Za pripravo osnove napitka, ena porcija espressa (30 mL), se uporablja espresso aparat (fino mleta kava in do 96 °C voda, 30 sekundna ekstrakcija tekoče-trdno pri cca. 9 barg). V visok kozarec najprej dodamo 270 mL parjenega mleka (toplo mleko, ki ga segrejemo in kremasto prezračimo z vročo vodno paro), ki ga ponavadi pripravimo s pomočjo espresso aparata. Nato pa dodamo porcijo espressa in pazimo, da se sloji ohranijo.",
    caffeine: 1.5,
    alternativeNames: "-",
    origin: "Italija, 9. desetletje 20. stoletja."
},

{
    ...
    preparation: "Najprej v visok kozarec nalijemo čokoladni sirup ali staljeno čokolado (30 mL). Nato dodamo dve porciji espressa (doppio, 60 mL) in premešamo. Na koncu dodamo še parjeno mleko (toplo mleko, ki ga segrejemo in kremasto prezračimo z vročo vodno paro), 210 mL, ki ga ponavadi pripravimo s pomočjo espresso aparata.",
...

{
    ...
    preparation: "Za pripravo napitka, najprej s pomočjo espresso aparata pripravimo eno porcijo espressa (fino mleta kava in do 96 °C voda, 30 sekundna ekstrakcija tekoče-trdno pri cca. 9 barg), 30 mL, ki jo nato razredčimo z vročo vodo do okoli 80 mL. S pomočjo istega aparata pripravimo tudi parjeno mleko (toplo mleko, ki ga segrejemo in kremasto prezračimo z vročo vodno paro), 80 mL, s katerim prekrijemo osnovo. Na koncu napitek prekrijemo še s cca. 40 mL mlečne pene, ki jo pripravimo s penilnikom mleka.",
    caffeine: {min: 1.5, max: 2},
...

{
    ...
    name: "Cold brew",
    category: "cold",
    cardImage: "images/cold_brew.png",
...

{
    ...
    category: "cold",
    cardImage: "images/nitro_cold_brew.png",
    detailImage: "images/nitro_cold_brew_1.webp",
    description: "Napitek nitro cold brew je cold brew, obogaten z dušikom, ki se natoči iz pipe, podobno kot točeno pivo. Dušik ustvari značilno kremasto teksturo brez dodajanja mleka. Napitek se običajno postreže brez sladkorja in brez ledu ter vsebuje precej kofeina – približno od 200 mg do 280 mg na približno 480 mL. Postreže se ga hladnega običajno v velikem kozarcu. Medtem ko se pri večini piv in brezalkoholnih pijač uporablja ogljikov dioksid, se dušik uporablja tudi pri nekaterih temnih pivih, kot je stout, kjer prispeva k bolj gladkemu zaključku. Gre za ameriško craft inovacijo iz začetka 2. desetletja 21. stoletja, katere izvor si pripisujeta tako mesto Portland (kavarna Stumptown Coffee Roasters) kot Austin (kavarna Cuvee Coffee). Danes je nitro cold brew na nekaterih trgih na voljo tudi v sodih, namenjenih točenju v kavarnah in drugih gostinskih obratih.",
    preparation: "Priprava nitro cold brew-a se začne s pripravo cold brew-a (namakanje kave v hladni vodi in s tem ekstrakcija trdno-tekoče od 12 ur do 24 ur). Ko se je mleta kava dovolj dolgo namakala, se 480 mL pripravljenega napitka prelije v steklenico ali sod pri sobni temperaturi. Pri točenju v velik kozarec se mu doda dušik (analogno kot pri dodajanju ogljikovega dioksida), ki ustvari bogato, kremasto plast pene (mikromehurčki), podobno peni pri točenem pivu.",
    caffeine: 5,
...

{
    ...
    detailImage: "images/iced_americano_1.webp",
...

{
    ...
    name: "Espresso tonic",
    category: "cold",
    cardImage: "images/espresso_tonic.png",
    detailImage: "images/espresso_tonic_1.webp",
    description: "Espresso tonic je skandinavski hladni napitek, pripravljen iz espressa, ki ga prelijemo čez tonik in led. Pri tem je približno razmerje med espressom in tonikom 1:3. Prvič naj bi ga pripravili v Oslu leta 2007, pozneje pa je postal znan kot kaffe & tonic v švedski pražarni Koppi. Grenkoba kinina in svežina citrusov poudarita značaj espressa ter ustvarita vtis deviškega kavnega koktajla. Napitek lahko pijemo po plasteh ali ga pred pitjem premešamo – tudi med baristi glede tega ni enotnega mnenja. Na običajno 300 mL porcijo, ki je postrežena v velikem kozarcu, je vsebnost kofeina od 64 mg do 128 mg. Napitek lahko vsebuje tudi sladkorni sirup in dekorativno rezino limone, dodamo pa mu lahko tudi druge modifikatorje okusa, na primer češnjo, limeto ali med. Zasluge za prve različice z dodatnimi aromami pripisujejo japonskim baristom. Po zgodbi naj bi espresso tonic nastal jutro po zabavi zaposlenih, ko so iz preostalega tonika pripravili nov napitek. Zgodba o njegovem nastanku je že zdavnaj prerasla svoje skromne začetke. Danes je namreč napitek bolj priljubljen v tujini kot v domovini in je postal stalnica poletnih menijev v kavarnah od Osla do Seula.",
    preparation: "Priprava napitka se začne s pripravo osnove. Ta je dvojna porcija espressa (doppio), ki znese 60 mL. Pripravimo jo s pomočjo espresso aparata (fino mleta kava in do 96 °C voda, 30 sekundna ekstrakcija tekoče-trdno pri cca. 9 barg). Nato v veliki kozarec nasujemo led in prilijemo okoli 180 mL tonika. Čez ohlajen tonik na koncu počasi dodamo doppio, da ohranimo sloje.",
    caffeine: {min:1.5, max:2.5},
...

{
    ...
    name: "Coffee soda",
    category: "cold",
    cardImage: "images/soda.png",
    detailImage: "images/soda_1.jpg",
    ...
    preparation: "Za pripravo napitka najprej pripravimo kavno osnovo. Če gre za espresso oz. doppio (60 mL), jo pripravimo s pomočjo espresso aparata (fino mleta kava in do 96 °C voda, 30 sekundna ekstrakcija tekoče-trdno pri cca. 9 barg). Potem, jo moramo najprej ohladiti do cca. sobne temperature preden jo uporabimo. V primeru, da je osnova cold brew (Priprava – namakanje kave v hladni vodi in s tem ekstrakcija trdno-tekoče od 12 ur do 24 ur), je ta že ohlajena in jo lahko kar uporabimo. Običajno ga nalijemo okoli 120 mL. V veliki kozarec nato nasujemo led in cca. 290 mL (v primeru doppio kavne osnove) oz. 230 mL (v primeru cold brew kavne osnove) izbrane gazirane pijače. Na koncu dodamo še pripravljeno kavno osnovo.",
    caffeine: {min:1, max:2},
    alternativeNames: "Sparkling coffee, carbonated coffee, fizzy coffee (angleško govoreče države), gazzosa al caffè, gassosa al caffè (Italija), espresso soda (globalno).",
...

{
    ...
    name: "Mazagran",
    category: "cold",
    cardImage: "images/mazagran.png",
    detailImage: "images/mazagran_1.jpg",
    description: "Mazagran je hladen, sladkan kavni napitek z limono, ki naj bi nastal proti koncu 19. stoletja v Alžiriji. Navaja se, da ime napitka verjetno izvira iz trdnjave Mazagran v obalnem mestu Mostaganem na severozahodu Alžirije, ki je bila leta 1837 s Tafnaškim sporazumom dodeljena Franciji. V trdnjavi so francoske kolonialne enote uživale napitek, pripravljen iz kavnega sirupa in hladne vode. Po drugi različici zgodbe naj bi ime in nastanek napitka izvirala od vojakov francoske tujske legije, ki so med obleganjem Mazagrana leta 1840 zaradi pomanjkanja mleka ali žganja svoji kavi dodajali vodo in jo pili hladno, da bi se lažje spopadli z vročino. Ko so se vojaki vrnili v Pariz, so tamkajšnjim kavarnam predlagali strežbo tega napitka, tudi v visokih kozarcih. V Franciji se kava, postrežena v kozarcu, še danes označuje tudi z izrazom mazagrin. Mazagran velja za eno prvih dokumentiranih oblik hladni kavnih napitkov z ledom, od drugih podobnih napitkov pa ga loči predvsem dodatek limone. Brez mleka, brez pene – le kava, citrusi in čas. Vsebnost kofeina napitka po navadi znese okoli 95 mg. Običajno se ga postreže v velikem kozarcu v količino cca. 250 mL. Napitek so pozneje prevzeli tudi na Portugalskem in v Avstriji. (pri portugalski različici se lahko dodaja limona, meta ali rum, pri avstrijski, pa rum ali maraschino – liker iz višenj maraska). V Kataloniji in Valenciji se napitek pripravlja tako, da se kavi doda led in limonina lupinica. Imenuje se café del temps v katalonščini oziroma café del tiempo v španščini, kar lahko prevedemo kot kava časa oziroma vremenska kava.",
    preparation: "Za pripravo napitka najprej pripravimo kavno osnovo. Če gre za espresso oz. doppio (60 mL), jo pripravimo s pomočjo espresso aparata (fino mleta kava in do 96 °C voda, 30 sekundna ekstrakcija tekoče-trdno pri cca. 9 barg). V primeru, da je osnova močan na katerikoli način pripravljen kavni napitek, bodisi drip coffee, french press coffee, itd., je razlaga priprave vsake posamezne osnove opisana v rubriki “Načini priprave” tega vodnika. Med pripravo kavne osnove ali tik po njej jo po želji sladkamo s sladkorjem, osnovnim sirupom ali medom. Običajno je uporabimo okoli 120 mL. Pred uporabo moramo osnovo ohladiti do cca. sobne temperature (razen v primeru uporabe cold brew osnove). Nato v velik kozarec nasujemo led in čez prelijemo kavno osnovo. Na koncu pa dodamo še nekaj limoninih rezin.",
    caffeine: 2,
    alternativeNames: "Portuguese iced coffee (Portugalska), café mazagran, masagran (globalno).",
