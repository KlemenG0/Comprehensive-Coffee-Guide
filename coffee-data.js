...

{
    ...
    preparation: "Priprava nitro cold brew-a se začne s pripravo cold brew-a (namakanje kave v hladni vodi in s tem ekstrakcija trdno-tekoče od 12 ur do 24 ur). Ko se je mleta kava dovolj dolgo namakala, se pripravljen napitek prelije v steklenico ali sod pri sobni temperaturi. Pri točenju v velik kozarec se mu doda dušik (analogno kot pri dodajanju ogljikovega dioksida), ki ustvari bogato, kremasto plast pene (mikromehurčki), podobno peni pri točenem pivu.",
    caffeine: 5,
