...

{
    ...
    description: "Pour-over je ročno pripravljena filtrirana kava, pri kateri vročo vodo postopoma prelivamo čez mleto kavo. Gre za počasen in natančen (gravitacijsko gnan) način priprave, ki se je izpopolnil v japonskih kavarnah kissaten, pozneje pa ga je standardiziral predvsem oprema Hario V60, predstavljena leta 2005. V primerjavi s klasično filtrirano kavo (drip coffee) način pour-over običajno proizvede čistejši in svetlejši napitek, pri katerem bolje pridejo do izraza značilnosti izvora kavnih zrn. Priprava pour-over kave se običajno začne tako, da papirnati filter prelijemo z majhno količino vroče vode, s čimer odstranimo morebiten okus po papirju. Nato dodamo mleto kavo in jo enakomerno poravnamo. Na kavo zlijemo manjšo količino vroče vode in počakamo približno 40 sekund, preden nadaljujemo s prelivanjem. To predhodno omočenje, imenovano “blooming” (slo. cvetenje), povzroči sproščanje ogljikovega dioksida (CO₂) iz kavne usedline v obliki mehurčkov ali pene ter lahko izboljša okus napitka. Preostalo odmerjeno količino vode nato počasi in enakomerno dolivamo s krožnimi gibi čez kavo, kar omogoča počasnejšo perkolacijo in ekstrakcijo trdno-tekoče. Prehitro dolivanje lahko povzroči bolj vodeno kavo, medtem ko lahko počasnejše prelivanje ustvari bogatejši okus. V nasprotju s pripravo v francoski stiskalnici (French press), kjer je kavna usedlina ves čas potopljena v vodi, pour-over omogoča natančnejši nadzor nad ekstrakcijo. Tudi dodatno mešanje oziroma premikanje kavne usedline, na primer z rahlim vrtenjem, lahko izboljša ekstrakcijo.",
    preparation: "",
    caffeine: 3,
